...
static HRESULT STDMETHODCALLTYPE d3d12_device_vkd3d_ext_CreateCommittedResourceFromBorrowedHandle(d3d12_device_vkd3d_ext_iface *iface,
...
CONST_VTBL struct ID3D12DeviceExt1Vtbl d3d12_device_vkd3d_ext_vtbl =
{
    ...
    d3d12_device_vkd3d_ext_CreateCommittedResourceFromBorrowedHandle,
};
